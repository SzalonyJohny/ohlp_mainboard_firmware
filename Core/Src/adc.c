...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA6     ------> ADC1_IN11
    */
    HAL_GPIO_DeInit(GPIOA, ADC_VD1_FB_Pin|ADC_VD2_FB_Pin|ADC_VD3_FB_Pin|ADC_ID1_FB_Pin
                          |ADC_ID2_FB_Pin|ADC_ID3_FB_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB0     ------> ADC2_IN15
    */
    HAL_GPIO_DeInit(ADC_I_IN_GPIO_Port, ADC_I_IN_Pin);
