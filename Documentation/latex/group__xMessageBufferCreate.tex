\hypertarget{group__xMessageBufferCreate}{}\doxysection{x\+Message\+Buffer\+Create}
\label{group__xMessageBufferCreate}\index{xMessageBufferCreate@{xMessageBufferCreate}}
...
config\+SUPPORT\+\_\+\+DYNAMIC\+\_\+\+ALLOCATION must be set to 1 or left undefined in \mbox{\hyperlink{FreeRTOSConfig_8h_source}{Free\+RTOSConfig.\+h}} for x\+Message\+Buffer\+Create() to be available.
