\hypertarget{group__xStreamBufferCreateStatic}{}\doxysection{x\+Stream\+Buffer\+Create\+Static}
\label{group__xStreamBufferCreateStatic}\index{xStreamBufferCreateStatic@{xStreamBufferCreateStatic}}
...
config\+SUPPORT\+\_\+\+STATIC\+\_\+\+ALLOCATION must be set to 1 in \mbox{\hyperlink{FreeRTOSConfig_8h_source}{Free\+RTOSConfig.\+h}} for x\+Stream\+Buffer\+Create\+Static() to be available.
