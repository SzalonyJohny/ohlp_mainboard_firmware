\hypertarget{group__xTaskAbortDelay}{}\doxysection{x\+Task\+Abort\+Delay}
\label{group__xTaskAbortDelay}\index{xTaskAbortDelay@{xTaskAbortDelay}}
task. h 
\begin{DoxyPre}BaseType\_t xTaskAbortDelay( TaskHandle\_t xTask );\end{DoxyPre}


INCLUDE\+\_\+x\+Task\+Abort\+Delay must be defined as 1 in \mbox{\hyperlink{FreeRTOSConfig_8h_source}{Free\+RTOSConfig.\+h}} for this function to be available.
