\hypertarget{group__xStreamBufferCreate}{}\doxysection{x\+Stream\+Buffer\+Create}
\label{group__xStreamBufferCreate}\index{xStreamBufferCreate@{xStreamBufferCreate}}
...
config\+SUPPORT\+\_\+\+DYNAMIC\+\_\+\+ALLOCATION must be set to 1 or left undefined in \mbox{\hyperlink{FreeRTOSConfig_8h_source}{Free\+RTOSConfig.\+h}} for x\+Stream\+Buffer\+Create() to be available.
