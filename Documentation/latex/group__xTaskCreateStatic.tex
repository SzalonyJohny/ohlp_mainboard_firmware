\hypertarget{group__xTaskCreateStatic}{}\doxysection{x\+Task\+Create\+Static}
\label{group__xTaskCreateStatic}\index{xTaskCreateStatic@{xTaskCreateStatic}}
task. h 
\begin{DoxyPre}
...
\hline
{\em pc\+Name} & A descriptive name for the task. This is mainly used to facilitate debugging. The maximum length of the string is defined by config\+MAX\+\_\+\+TASK\+\_\+\+NAME\+\_\+\+LEN in \mbox{\hyperlink{FreeRTOSConfig_8h_source}{Free\+RTOSConfig.\+h}}.\\
\hline
